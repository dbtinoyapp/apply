...
class SpinnerButton extends FormButton
{
    ...
    public function render(ElementInterface $element, $buttonContent = null)
    {
        ...
        $buttonContent = '<div><div class="processing ppt-hidden"><span class="fa-spin ppt-icon-spinner ppt-icon"></span> ' . $translator->translate('processing', $this->getTranslatorTextDomain()) . '</div><div class="default">' . $escape($buttonContent) . '</div></div>';
