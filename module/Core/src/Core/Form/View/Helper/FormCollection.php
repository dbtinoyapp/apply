    ...
    public function render(ElementInterface $element)
    {
        ...
        if ($this->shouldWrap) {
            ...
            if ($this->isWithinCollection) {
                ...
                $markup = sprintf('<fieldset %s><a class="remove-item ats-form-remove"><i class="fa fa-trash-o"></i> Remove</a>%s</fieldset>', $attrStr, $markup);
            } else {
                ...
                if (empty($label) && $element->getOption('renderFieldset')) {
                    ...
                    if ($isCollectionElement) {
                        $extraLegend = '<a href="#" class="add-item ats-form-add"><i class="ppt-icon ppt-icon-plus"></i></a>';
