...
return array(
    ...
    // Zend_Validator_Csrf
    "The form submitted did not originate from the expected site"                                                               => 'Der Ursprung des abgesendeten Formes konnte nicht bestätigt werden',
    ...
    "File '%value%' exceeds the defined form size"                                                                              => "Die Datei '%value%' übersteigt die definierte Größe des Forms",
