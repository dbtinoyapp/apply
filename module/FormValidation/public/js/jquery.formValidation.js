...
$(document).ready(function() {
    ...
    $('form.validate').bind('submit', function(event) {
        ...
        if (!semaphor_formvalidation) {
            ...
            submits.find('.default').addClass('ppt-hidden');
            submits.find('.processing').removeClass('ppt-hidden');
            $.post(action,erg,function(data) {
                // remove process-icon
                submits.find('.default').removeClass('ppt-hidden');
                submits.find('.processing').addClass('ppt-hidden');
