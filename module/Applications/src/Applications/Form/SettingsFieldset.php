...
public function init()
    {
        ...
        $this->add(array('type' => 'Zend\Form\Element\Checkbox',
        		...
        		'options' => array('label' => /* @translate */ 'hire application immidiately after submit',
        		                   'description' => /* @translate */ 'if checked, an application is immediatly hired. If unchecked confirmation is the duty of the recruiter.'),
        		));
        $this->add(array('type' => 'Zend\Form\Element\Textarea',
        ...
        $this->add(array('type' => 'Zend\Form\Element\Textarea',
        		'name' => 'mailProcessText',
        		'options' => array('label' => /* @translate */ 'In-process mail text',
        		                    'description'=> /* @translate */ 'default text of the in-process mail to the applicant. You can use all variables of the acknowledgment of receipt mail. '
        		                    )));
        
        $this->add(array('type' => 'Zend\Form\Element\Textarea',
        		'name' => 'mailFailureText',
        		'options' => array('label' => /* @translate */ 'Failure mail text',
