 ...
 */
class Application extends AbstractIdentifiableModificationDateAwareEntity implements ApplicationInterface, ResourceInterface, PreUpdateAwareInterface {
...
//    protected $attachments;
    ...
    public function preUpdate($isNew = false) {
        ...
        if ($isNew || $comments instanceOf ArrayCollection // new Comments
...
//        return $this->cv;
//    }
//    public function populateCv(CvInterface $cv) {
//        /* @TODO: Make this dynamic */
//        if($title = $cv->getTitle()) {
//            $this->getCv()
//                ->setTitle($title) ;
//        }
//        $this->getCv()
//                ->setEducations($cv->getEducations())
//                ->setTrainings($cv->getTrainings())
//                ->setEmployments($cv->getEmployments())
//                ->setNativeLanguages($cv->getNativeLanguages())
//                ->setOtherLanguages($cv->getOtherLanguages())
//                ->setComputingSkills($cv->getComputingSkills());
//    }
