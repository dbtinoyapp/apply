...
translate('hire application immidiatly after submit');

//: ./src/Applications/Form/SettingsFieldset.php:46
translate('if checked, an application is immediatly hireed. If unchecked hireation is the duty of the recruiter.');

//: ./src/Applications/Form/SettingsFieldset.php:50
translate('Hireation mail text');
...
translate('Application hireation');
